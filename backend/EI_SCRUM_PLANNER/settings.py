"""
Django settings for EI_SCRUM_PLANNER project.
...
SECRET_KEY = 'django-insecure-#^8i7qm@4)o$h-bw_#on!a6goato%=w4z=^eh@gqt9xtsb3r9c'
...
WSGI_APPLICATION = 'EI_SCRUM_PLANNER.wsgi.application'
